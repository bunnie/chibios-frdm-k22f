  ...
  .ports = {
    {
      .port = IOPORT1,  // PORTA
      .pads = {
        /* PTA0*/ PAL_MODE_ALTERNATIVE_7,   /* PTA1*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTA2*/ PAL_MODE_OUTPUT_PUSHPULL,
        /* PTA3*/ PAL_MODE_ALTERNATIVE_7,   /* PTA4*/ PAL_MODE_UNCONNECTED,     /* PTA5*/ PAL_MODE_ALTERNATIVE_6,
        ...
        /*PTA12*/ PAL_MODE_ALTERNATIVE_6,   /*PTA13*/ PAL_MODE_ALTERNATIVE_6,   /*PTA14*/ PAL_MODE_UNCONNECTED,
    ...
    },
    {
      .port = IOPORT2,  // PORTB
      .pads = {
        /* PTB0*/ PAL_MODE_UNCONNECTED,     /* PTB1*/ PAL_MODE_UNCONNECTED,     /* PTB2*/ PAL_MODE_ALTERNATIVE_2, // i2c0
    ...
    },
    {
      ...
      .pads = {
        ...
        /* PTC9*/ PAL_MODE_ALTERNATIVE_4,   /*PTC10*/ PAL_MODE_UNCONNECTED,     /*PTC11*/ PAL_MODE_UNCONNECTED,
    ...
    },
    {
      .port = IOPORT5,  // PORTE
      .pads = {
        /* PTE0*/ PAL_MODE_ALTERNATIVE_3,     /* PTE1*/ PAL_MODE_ALTERNATIVE_3,     /* PTE2*/ PAL_MODE_UNCONNECTED,
	/* UART1_TX */                        /* UART1_RX */
